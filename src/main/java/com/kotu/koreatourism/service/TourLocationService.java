...
public interface TourLocationService {
    ...
    //지역기반
    public String areaBasedAPI(String callBackUrl, String serviceKey, String dataType, int contentTypeId, String numOfRows, String pageNo, TourAreaSigunguDTO areaSigunguCode) throws IOException;
